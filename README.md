...
Soy un desarrollador apasionado por crear **soluciones digitales eficientes y escalables**, combinando desarrollo web, aplicaciones móviles y automatización.  
Recientemente concluí mi estadía profesional en el **Instituto de Innovación y Competitividad (IIC)**, donde participé como desarrollador principal del **Sistema Estatal de Investigadores (SEI)**.
